    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['device:table:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['device:table:export']"
        >导出</el-button>
      </el-col>
...
import { getNewStatus, updateStatus } from "@/api/iot/status";
import { getNewSet, updateSet } from "@/api/iot/set";
